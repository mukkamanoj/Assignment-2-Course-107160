...
sales <- read.csv("~/Public/rstudio-projects/Assignment2/yearly_sales.csv")
...
setwd("~/Public/rstudio-projects/Assignment2")
sales <- read.csv("~/Public/rstudio-projects/Assignment2/yearly_sales.csv")
...
jpeg(file="~/Public/rstudio-projects/Assignment2/sales_hist.jpeg") # create a new jpeg file
